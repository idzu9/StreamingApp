...
const std::string PostProcessingHumanSegmentationLayer::HumanSegmentationModelPath = "../../../../StreamingApp/resources/models/human_segmentation_pphumanseg_2023mar.onnx";
